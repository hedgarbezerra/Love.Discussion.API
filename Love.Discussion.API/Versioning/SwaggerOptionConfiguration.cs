...
namespace Love.Discussion.API.Versioning
{
    public class SwaggerOptionConfiguration : IConfigureOptions<SwaggerGenOptions>
    {
        ...
        static OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description)
        {
            ...
            {
                Title = "Love and Discussion",
                Version = description.ApiVersion.ToString(),
                Description = "Simple API to manage complains with JWT Authentication and Authorization security.",
